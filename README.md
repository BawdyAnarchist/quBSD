...
*Note final overhaul being conducted now, implementing a comprehensive shell framework.*
*This will bring the project to a production ready status, and then be added to ports.*

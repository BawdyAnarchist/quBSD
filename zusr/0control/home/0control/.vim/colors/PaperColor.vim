...
call s:HL("cssClassName", s:pink, "", "")
  ...
  " Maven (pom.xml) Highlighting
  call s:HL("modelVersionMatch", s:wine, "", "bold")

call s:HL("tagContentsRegion", s:foreground, "", "")
call s:HL("groupIdMatch", s:blue, "", "")

call s:HL("versionMatch", s:blue, "", "")
call s:HL("artifactIdMatch", s:blue, "", "")
  " }}}

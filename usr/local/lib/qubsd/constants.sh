...
export DEBUG_PATH="/root/debug"
export LOG_PATH="/root/loglog"
...
export PARAMS_HOST="AUTOSNAP,CLASS,GATEWAY,IPV4,MTU"  # Only modifiable params for "cell" `host'
export PARAMS_EXCL_DEFAULT="CLASS,PPT,TEMPLATE"
export CONTEXT="EXT_IF,INT_IF,JCONF,QCONF,OWNER,PARAMS_TYPE,P_DSET,P_MNT,R_DSET,R_MNT,RT_CTX,TYPE"  # Convenient supplemental context
...
# Cached query globals for rapid stacked/looped information retreival
